...
(function (t, e) {
    ...
    function n(t, n) {
        ...
        for (var r = 0, o = i.length; o > r; r++)(function () {
            var t = i[r];
    ...
    function r(e) {
        ...
        return new t({color: n || "#fff", lines: r, radius: a, length: o, width: s, zIndex: "initial", top: "auto", left: "auto", className: ""})
    }

            ...
            angular.forEach(this.$schema, function (definition, field) {
              ...
              Object.defineProperty(model, field, {
                ...
                set: function (value) {
                  ...
                  default:
                    assert(Object.prototype.toString.call(value) === '[object ' + type + ']');
                  }
                  if (!simpleDefinition && angular.isDefined(definition.validator) && angular.isFunction(validators[definition.validator])) {
              ...
              if (angular.isDefined(definition.default) && angular.isFunction(defaults[definition.default])) {

...
(function () {
  ...
  angular.module('zoltarCommonServices').provider('Schema',
    function ($provide, zoltarSchemas, $validatorProvider) {
      ...
      this.init = function init() {
        ...
        angular.forEach(validators,
          function (validator, name) {
            $validatorProvider.addValidator(name,
              validator);
          });

        angular.forEach(formatters,
          function (formatter, name) {
            $validatorProvider.addFormatter(name,
              formatter);
          });

        angular.forEach(zoltarSchemas,
          function (data, name) {
            ...
            model.prototype.$defineProperties =
              function () {
                var model = this;
                angular.forEach(this.$schema,
